...
#define MIN_SPEED 1148 // 1148 | 1000 bpth values depend on the motor
...
void loop() {
  ...
  inputPerc[0]=myData.throttle-myData.pitch-myData.roll-myData.yaw; // to show basic controll
  ...
  for(int i=0;i<4;i++)
  {
    ...
    inputPerc[i]=min(inputPerc[i], 0.60f); // should be 1.00 used for showcasing
